...
public class Vector implements Cloneable, Serializable {
	 ...
	 * @see #add(Vector)
	 * 
	 * @param vx Das erste Element des Summanden
	 * @param vy Das zweite Element des Summanden
	 * @return Summe
	 */
	...
	/**
	 * @param vx Das erste Element des zweiten Vektors
	 * @param vy Das zweite Element des zweiten Vektors
	...
	/**
	 * @param other Der zweite Ortsvektor
	 ...
	 * 
	 * @param ox Das erste Element des zweiten Ortsvektors
	 * @param oy Das zweite Element des zweiten Ortsvektors
	 * @return Der Abstand zwischen den beiden Orten, die durch die Vektoren
	 *         beschrieben werden.
	 */
	 ...
	 * Erzeugt einen neuen Vektor.
	 * 
	 * @param x Nur der X-Wert wird verändert
	 ...
	 * Erzeugt einen neuen Vektor.
	 * 
	 * @param y Nur der Y-Wert wird verändert
	 * @return Der neue Vektor
	 */
	...
	/**
	 * Ein monotoner Hash-Wert für die Länge des Vektors, der effizienter berechnet
	 * wird, als die Länge selbst. Eignet sich gut, um Längen zu vergleichen.
	 * 
	 ...
	 * @see #sub(Vector)
	 * 
	 * @param vx Das erste Element des Subtrahenten
	 * @param vy Das zweite Element des Subtrahenten
	 * @return Differenz
	 */
	...
	/**
	 * Gibt an, ob der Vektor <b>stärker</b> nach oben ({@link #UP}) zeigt, als der
	 * andere. Dabei wird nur die Richtung, nicht der Betrag beachtet.
	 * 
	 * @param other Der andere Vektor
	 * @return true, wenn dieser Vektor mehr nach oben zeigt als der andere, sonst
	 *         false
	 */
	...
	public float ang(Vector other) {
		return (float) Math.acos(this.mul(other) / this.abs() / other.abs());
	}

	/**
	 * Der Innenwinkel im Bogenmaß zwischen dem Vektor und einem Vektor, der nach
	 * oben zeigt.
	 * 
	 * @see #UP
	 * @see #ang(Vector)
	 */
	public float ang() {
		return this.ang(Vector.UP);
	}

	/**
	 * Der Winkel im Uhrzeigersinn vom Vektor, der nach oben zeigt, bis zu diesem
	 * Vektor im Bogenmaß
	 */
	 ...
	 * @return Der Ortsvektor des neuen um <code>phi</code> um <code>point</code>
	 *         rotierten Punktes
	 */
	 ...
	 * rotieren
	 * 
	 * @param phi Der Winkel, um den der Vektor rotiert werden soll
	 * @return Der rotierte Vektor
	 */
	public Vector rotate(float phi) {
		return new Vector((float) (this.x * Math.cos(phi) - this.y * Math.sin(phi)),
				(float) (this.x * Math.sin(phi) + y * Math.cos(phi)));
	}
