...
public abstract class Line {
	 ...
	 * y-Region liegt)
	 * 
	 * @param point Der Ortsvektor des Punktes
	...
	public boolean crosses(Line other) {
		boolean canCross = !(this.a * other.b == this.b * other.a && this.b * other.c == this.c * other.b
				&& this.a * other.c == this.c * other.a) && !(this.a == 0 && this.b == 0)
				&& !(other.a == 0 && other.b == 0) && !(this.a * other.b == this.b * other.a);
		if (canCross) {
			Vector crossPoint = this.getCrossingPoint(other);
			return this.canPointBeOnLine(crossPoint) && other.canPointBeOnLine(crossPoint);
		} else {
			return false;
		}
	}
	...
	public Vector getCrossingPoint(Line other) {
		...
		if (this.a != 0) {
			float y = (other.a / this.a * this.c - other.c) / (other.b - other.a / this.a * this.b);
			float x = (this.b * y + this.c) / (-this.a);
			return new Vector(x, y);
		} else {
			float x = (other.b / this.b * this.c - other.c) / (other.a - other.b / this.b * this.a);
	...
	public boolean isPointOnLine(Vector point) {
		return this.canPointBeOnLine(point) && this.a * point.x + this.b * point.y + this.c == 0;
	}
	...
	/**
	 * @param point Der Ortsvektor eines beliebigen Punktes
	 * @return Die Distanz zwischen dem Punkt und dieser Geraden
	 */
	public float getDistanceTo(Vector point) {
		return (float) ((this.a * point.x + this.b * point.y + this.c) / Math.sqrt(this.a * this.a + this.b * this.b));
	}
	...
	public final boolean arePointsOnTheSameSide(Vector point1, Vector point2) {
		return Math.signum(this.getDistanceTo(point1)) == Math.signum(this.getDistanceTo(point2));
	}
