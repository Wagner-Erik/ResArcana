...
public class MaskAnimation implements Animation {

	private final Shape rawMask;
	...
	public MaskAnimation(Shape rawMask, Rectangle imageBox, PathGenerator path, String image, float lifetime) {
		this.rawMask = rawMask.modifyCenter(Vector.ZERO);
	...
	public void draw(Graphics g) {
		if (this.isRunning()) {
			...
			g.scale(scale, scale);
			GraphicUtils.fill(g, this.rawMask);
			g.popTransform();
