...
public interface AbstractEngine {
	...
	/**
	 * Fügt einen Zustand hinzu, sodass er später aufgerufen werden kann. Wird ein
	 * existierender Zustand hinzugefügt, wird keine Aktion ausgeführt.
	 * 
	 * @param state Neuer Zustand der Grafikengine.
	 */
	...
	/**
	 * Bereitet den neuen Zustand vor, beendet den alten und startet den neuen. Der
	 * alte Zustand wird nicht neu initialisiert, wenn neuer und alter Zustand die
	 * selben sind.
	 * 
